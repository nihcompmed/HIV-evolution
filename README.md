...
Run swarm_simulate.sh on HPC to simulate evolution trajectories. Script simulate_trajectories/simulate_PR_trajectories.sh is the worker that simulates the trajectories.
