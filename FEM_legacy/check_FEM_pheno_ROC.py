...
dbfile = open(f'PR_{drug}_onehot_dict.p', 'rb')
...
#print('false pos percent',false_pos/len(all_yy)*100, 'false neg percent', false_neg/len(all_yy)*100)


#print(all_yy[false_idxs])

#fpr, tpr, thresholds = sklearn.metrics.roc_curve(all_yy, pred_true)
#
